...
insert  into `system_authority`(`id`,`authority_name`,`authority_url`,`parent`) values (1,'入住管理','#',0),(2,'订单管理','#',0),(3,'会员管理','#',0),(4,'客房管理','#',0),(5,'用户管理','#',0),(6,'客人意见','#',0),(7,'入住信息查询','/getInRoomInfo.do',1),(8,'入住信息添加','/checkIn.do',1),(9,'消费记录','#',1),(10,'结账退房','/jieZhang.do',1),(11,'订单信息','/getAllOrders.do',2),(12,'订单添加','/toAddOrder.do',2),(13,'会员信息查询','/getAllVip.do',3),(14,'会员信息管理','#',3),(15,'添加会员','/pages/admin/vip/addvip.jsp',3),(16,'客房信息查询','/getHouseInfo.do',4),(17,'客房信息管理','/getHouseManage.do',4),(18,'添加客房','#',4),(19,'用户信息查询','#',5),(20,'用户信息管理','#',5),(21,'添加用户','#',5),(22,'客人意见','#',6);
