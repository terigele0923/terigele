	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="<%=basePath%>/addVipInfo.do" method="POST">
					<ul class="forminfo">
						<li>
							<label>会员姓名<b>*</b></label>
							<input placeholder="长度为2-20位的字符" name="customerName" type="text"
						...
						<li>
							<div style="position: relative">
								<label>身份证号码<b>*</b></label> <input placeholder="请输入正确的身份证号" name="idcard" type="text"
						...
						<li>
							<div>
								<label>手机号码<b>*</b></label> <input placeholder="请输入正确的手机格式" name="phone" type="text"
