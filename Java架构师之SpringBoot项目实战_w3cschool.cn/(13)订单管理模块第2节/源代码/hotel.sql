...
insert  into `orders`(`id`,`order_num`,`order_money`,`order_status`,`room_id`,`create_date`) values (2,'f79ca7db-3383-4b4f-8faa-da59e769bf2a',200.00,'1',7,'2018-10-24 11:08:42'),(3,'7d0a3f0a-f576-4b2c-b5b7-17084fae9916',3.50,'1',7,'2018-10-24 11:11:21');
...
insert  into `user_authority`(`user_id`,`authority_id`) values (1,1),(1,7),(1,8),(1,9),(1,10),(1,2),(1,11),(1,12);
