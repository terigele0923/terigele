...
insert  into `room_type`(`id`,`room_type_name`,`room_price`) values (1,'单人间',140.00),(2,'双人间',180.00),(3,'豪华间',280.00),(5,'总统套房',500.00),(6,'钟点房',100.00);
...
insert  into `rooms`(`id`,`room_num`,`room_status`,`room_type_id`) values (1,'8201','1',1),(2,'8202','2',1),(3,'8203','1',1),(4,'8204','1',2),(5,'82044','2',2),(6,'8205','1',3),(7,'8206','2',3),(8,'8207','0',2);
...
insert  into `system_authority`(`id`,`authority_name`,`authority_url`,`parent`) values (1,'入住管理','#',0),(2,'订单管理','#',0),(3,'会员管理','#',0),(4,'客房管理','#',0),(5,'用户管理','#',0),(6,'客人意见','#',0),(7,'入住信息查询','/getInRoomInfo.do',1),(8,'入住信息添加','/checkIn.do',1),(9,'消费记录','#',1),(10,'结账退房','/jieZhang.do',1),(11,'订单信息','/getAllOrders.do',2),(12,'订单添加','/toAddOrder.do',2),(13,'会员信息查询','/getAllVip.do',3),(14,'会员信息管理','#',3),(15,'添加会员','/pages/admin/vip/addvip.jsp',3),(16,'客房信息查询','/getHouseInfo.do',4),(17,'客房信息管理','/getHouseManage.do',4),(18,'添加客房','/pages/admin/room/addRoom.jsp',4),(19,'用户信息查询','#',5),(20,'用户信息管理','#',5),(21,'添加用户','#',5),(22,'客人意见','#',6);
...
insert  into `user_authority`(`user_id`,`authority_id`) values (1,1),(1,7),(1,8),(1,9),(1,10),(1,2),(1,11),(1,12),(1,3),(1,13),(1,14),(1,15),(1,4),(1,16),(1,17),(1,18);
